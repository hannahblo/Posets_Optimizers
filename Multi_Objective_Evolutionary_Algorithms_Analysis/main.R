# Analysis of the Multi-Objective Evolutionary Algorithms
# Wu, F., Wang, W., Chen, J. et al. A dynamic multi-objective optimization method
# based on classification strategies. Sci Rep 13, 15221 (2023).
# https://doi.org/10.1038/s41598-023-41855-2
# https://www.nature.com/articles/s41598-023-41855-2 (accessed: 06.12.23)

# The performance measures are taken from Table 2 and Table 3 of the above paper
...
################################################################################
#
# we convert the evaluations to the observed set of posets
#
################################################################################
